...
// Created on 01.09.2024 00:00:59
...
public:
	...
	static inline const String Mp3PlayerName_PipVoiceSound = "PipVoiceSound";
	...
	ProjectData(TCallBackErrorOccured errorOccured)
	{
		...
		mp3PlayersDfPlayerMini->push_back(Mp3PlayerDfPlayerMiniSerial(17, 16, 5, "PipVoiceSound", "Mp3PlayerDFPlayerMini-1", errorOccured));
