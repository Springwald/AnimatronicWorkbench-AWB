...
// Created on 25.08.2024 22:13:04
...
public:
	...
	void addTimelines()
	{
		...
		Timeline *timeline1 = new Timeline(state1, 1, String("Idle 1"), stsServoPoints1, scsServoPoints1, pca9685PwmServoPoints1, mp3PlayerYX5300Points1);
		...
		Timeline *timeline2 = new Timeline(state2, 1, String("Idle 2"), stsServoPoints2, scsServoPoints2, pca9685PwmServoPoints2, mp3PlayerYX5300Points2);
		...
		Timeline *timeline3 = new Timeline(state3, 1, String("Idle 3"), stsServoPoints3, scsServoPoints3, pca9685PwmServoPoints3, mp3PlayerYX5300Points3);
		...
		Timeline *timeline4 = new Timeline(state4, 1, String("Idle 4"), stsServoPoints4, scsServoPoints4, pca9685PwmServoPoints4, mp3PlayerYX5300Points4);
		...
		Timeline *timeline5 = new Timeline(state5, 2, String("Sleeping"), stsServoPoints5, scsServoPoints5, pca9685PwmServoPoints5, mp3PlayerYX5300Points5);
		...
		Timeline *timeline6 = new Timeline(state6, 1, String("Evil"), stsServoPoints6, scsServoPoints6, pca9685PwmServoPoints6, mp3PlayerYX5300Points6);
		...
		Timeline *timeline7 = new Timeline(state7, 2, String("Go Sleep"), stsServoPoints7, scsServoPoints7, pca9685PwmServoPoints7, mp3PlayerYX5300Points7);
		...
		Timeline *timeline8 = new Timeline(state8, -1, String("Rainbow"), stsServoPoints8, scsServoPoints8, pca9685PwmServoPoints8, mp3PlayerYX5300Points8);
		...
		Timeline *timeline9 = new Timeline(state9, 2, String("StartUp"), stsServoPoints9, scsServoPoints9, pca9685PwmServoPoints9, mp3PlayerYX5300Points9);
		...
		Timeline *timeline10 = new Timeline(state10, 1, String("Wake up"), stsServoPoints10, scsServoPoints10, pca9685PwmServoPoints10, mp3PlayerYX5300Points10);
