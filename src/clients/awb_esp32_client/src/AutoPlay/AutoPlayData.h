...
// Created on 15.03.2024 21:15:33
...
public:
    ...
    AutoPlayData()
    {
		...
		scsServoPoints2->push_back(StsServoPoint(12,0,80));
		scsServoPoints2->push_back(StsServoPoint(10,0,870));
		...
		scsServoPoints3->push_back(StsServoPoint(12,0,80));
		scsServoPoints3->push_back(StsServoPoint(10,0,870));
		...
		scsServoPoints4->push_back(StsServoPoint(12,0,80));
		scsServoPoints4->push_back(StsServoPoint(10,0,870));
		...
		scsServoPoints5->push_back(StsServoPoint(12,0,80));
		scsServoPoints5->push_back(StsServoPoint(10,0,870));
		...
		scsServoPoints6->push_back(StsServoPoint(12,0,80));
		scsServoPoints6->push_back(StsServoPoint(10,0,870));
		...
		scsServoPoints6->push_back(StsServoPoint(12,2500,282));
		...
		scsServoPoints6->push_back(StsServoPoint(12,3375,112));
		stsServoPoints6->push_back(StsServoPoint(11,4000,3712));
		scsServoPoints6->push_back(StsServoPoint(12,4375,306));
		stsServoPoints6->push_back(StsServoPoint(11,5000,3614));
		scsServoPoints6->push_back(StsServoPoint(12,5500,217));
		...
		scsServoPoints7->push_back(StsServoPoint(10,0,548));
		scsServoPoints7->push_back(StsServoPoint(12,0,346));
		...
		scsServoPoints7->push_back(StsServoPoint(2,4625,510));
		...
		scsServoPoints8->push_back(StsServoPoint(10,0,516));
		scsServoPoints8->push_back(StsServoPoint(12,0,322));
		...
		scsServoPoints8->push_back(StsServoPoint(10,2875,387));
		scsServoPoints8->push_back(StsServoPoint(12,2875,580));
		...
		scsServoPoints8->push_back(StsServoPoint(10,6625,564));
		scsServoPoints8->push_back(StsServoPoint(12,6625,354));
		...
		scsServoPoints9->push_back(StsServoPoint(10,0,548));
		scsServoPoints9->push_back(StsServoPoint(12,0,346));
		...
		scsServoPoints10->push_back(StsServoPoint(10,0,548));
		scsServoPoints10->push_back(StsServoPoint(12,0,346));
		...
		scsServoPoints10->push_back(StsServoPoint(10,1500,540));
		...
		scsServoPoints10->push_back(StsServoPoint(10,2250,628));
		scsServoPoints10->push_back(StsServoPoint(12,2250,282));
		stsServoPoints10->push_back(StsServoPoint(7,2750,2144));
		stsServoPoints10->push_back(StsServoPoint(8,3875,1765));
		scsServoPoints10->push_back(StsServoPoint(10,4000,645));
		scsServoPoints10->push_back(StsServoPoint(12,4000,330));
		...
		scsServoPoints10->push_back(StsServoPoint(10,6500,645));
		scsServoPoints10->push_back(StsServoPoint(12,6500,322));
		stsServoPoints10->push_back(StsServoPoint(6,7000,2082));
		scsServoPoints10->push_back(StsServoPoint(10,7750,564));
		scsServoPoints10->push_back(StsServoPoint(12,7750,274));
		...
		scsServoPoints11->push_back(StsServoPoint(10,0,548));
		scsServoPoints11->push_back(StsServoPoint(12,0,346));
