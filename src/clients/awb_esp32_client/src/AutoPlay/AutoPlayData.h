...
// Created on 28.04.2024 22:06:37
...
public:
    ...
    AutoPlayData()
    {
		...
		scsServoPoints6->push_back(StsServoPoint(3,0,571));
		stsServoPoints6->push_back(StsServoPoint(9,0,655));
		stsServoPoints6->push_back(StsServoPoint(6,1000,2219));
		stsServoPoints6->push_back(StsServoPoint(11,1000,3706));
		stsServoPoints6->push_back(StsServoPoint(11,2000,3712));
		scsServoPoints6->push_back(StsServoPoint(12,2375,512));
		stsServoPoints6->push_back(StsServoPoint(11,3000,3429));
		...
		scsServoPoints6->push_back(StsServoPoint(12,3000,121));
		scsServoPoints6->push_back(StsServoPoint(12,3375,333));
		stsServoPoints6->push_back(StsServoPoint(11,4000,3712));
		scsServoPoints6->push_back(StsServoPoint(12,4000,328));
		scsServoPoints6->push_back(StsServoPoint(12,4375,273));
		stsServoPoints6->push_back(StsServoPoint(11,5000,3411));
		scsServoPoints6->push_back(StsServoPoint(12,5000,161));
		stsServoPoints6->push_back(StsServoPoint(8,5500,1975));
		stsServoPoints6->push_back(StsServoPoint(7,5500,1868));
		stsServoPoints6->push_back(StsServoPoint(11,7000,3712));
		scsServoPoints6->push_back(StsServoPoint(12,7000,321));
		stsServoPoints6->push_back(StsServoPoint(7,7000,2205));
		stsServoPoints6->push_back(StsServoPoint(11,8000,3366));
		scsServoPoints6->push_back(StsServoPoint(12,8375,75));
		...
		scsServoPoints8->push_back(StsServoPoint(5,0,1024));
		...
		scsServoPoints8->push_back(StsServoPoint(4,2000,887));
		scsServoPoints8->push_back(StsServoPoint(5,2000,193));
		scsServoPoints8->push_back(StsServoPoint(4,3000,177));
		...
		scsServoPoints8->push_back(StsServoPoint(5,3375,1024));
		...
		scsServoPoints9->push_back(StsServoPoint(4,0,137));
		...
		scsServoPoints9->push_back(StsServoPoint(10,1500,677));
		scsServoPoints9->push_back(StsServoPoint(5,1500,387));
		scsServoPoints9->push_back(StsServoPoint(4,1500,733));
		stsServoPoints9->push_back(StsServoPoint(6,2000,1854));
		scsServoPoints9->push_back(StsServoPoint(10,2250,740));
		scsServoPoints9->push_back(StsServoPoint(12,2250,496));
		stsServoPoints9->push_back(StsServoPoint(7,2750,2144));
		stsServoPoints9->push_back(StsServoPoint(8,3875,1765));
		scsServoPoints9->push_back(StsServoPoint(10,4000,752));
		scsServoPoints9->push_back(StsServoPoint(12,4000,463));
		scsServoPoints9->push_back(StsServoPoint(4,4625,733));
		scsServoPoints9->push_back(StsServoPoint(5,4625,387));
		...
		scsServoPoints9->push_back(StsServoPoint(4,6125,0));
		scsServoPoints9->push_back(StsServoPoint(5,6125,1024));
		scsServoPoints9->push_back(StsServoPoint(10,6500,752));
		scsServoPoints9->push_back(StsServoPoint(12,6500,469));
		stsServoPoints9->push_back(StsServoPoint(6,7000,2082));
		scsServoPoints9->push_back(StsServoPoint(10,7750,694));
		scsServoPoints9->push_back(StsServoPoint(12,7750,501));
		...
		scsServoPoints10->push_back(StsServoPoint(4,0,40));
		...
		scsServoPoints10->push_back(StsServoPoint(5,2375,395));
		scsServoPoints10->push_back(StsServoPoint(4,2375,507));
		...
		scsServoPoints10->push_back(StsServoPoint(4,3875,0));
		scsServoPoints10->push_back(StsServoPoint(5,3875,854));
		...
		scsServoPoints13->push_back(StsServoPoint(10,0,841));
		scsServoPoints13->push_back(StsServoPoint(3,0,571));
		scsServoPoints13->push_back(StsServoPoint(10,250,480));
		stsServoPoints13->push_back(StsServoPoint(9,375,453));
		stsServoPoints13->push_back(StsServoPoint(8,375,1975));
		scsServoPoints13->push_back(StsServoPoint(10,500,856));
		stsServoPoints13->push_back(StsServoPoint(9,750,688));
		scsServoPoints13->push_back(StsServoPoint(10,2000,885));
		stsServoPoints13->push_back(StsServoPoint(9,2500,736));
		scsServoPoints13->push_back(StsServoPoint(10,2500,896));
		...
		scsServoPoints14->push_back(StsServoPoint(4,0,0));
		scsServoPoints14->push_back(StsServoPoint(5,0,854));
		scsServoPoints14->push_back(StsServoPoint(10,0,659));
		scsServoPoints14->push_back(StsServoPoint(12,0,469));
		...
		scsServoPoints14->push_back(StsServoPoint(4,2250,854));
		scsServoPoints14->push_back(StsServoPoint(5,2250,169));
		scsServoPoints14->push_back(StsServoPoint(10,2875,567));
		scsServoPoints14->push_back(StsServoPoint(12,2875,296));
		...
		scsServoPoints14->push_back(StsServoPoint(4,6500,0));
		scsServoPoints14->push_back(StsServoPoint(5,6500,1024));
		scsServoPoints14->push_back(StsServoPoint(10,6625,694));
		scsServoPoints14->push_back(StsServoPoint(12,6625,447));
