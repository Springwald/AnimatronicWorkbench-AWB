...
public:
    // the constructor
    Mp3PlayerYX5300Serial(int rxPin, int txPin, TCallBackErrorOccured errorOccured, TCallBackMessageToShow messageToShow) : _errorOccured(errorOccured), _messageToShow(messageToShow), _mp3Stream(rxPin, txPin), _mp3(MD_YX5300(_mp3Stream))
    {
