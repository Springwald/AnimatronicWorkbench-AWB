...
public:
    ...
    // the constructor
    Mp3PlayerDfPlayerMiniSerial(int rxPin, int txPin, int volume, String name, String id, TCallBackErrorOccured errorOccured) : name(name), id(id), _errorOccured(errorOccured)
    {
